...
class App {
  constructor() {
    ...
    this.x10 = /** @type {HTMLButtonElement} */ (
      document.querySelector('#btn-10x')
    );
    ...
    this.x10.addEventListener('click', () => {
      // Sends a message to the Devvit app
      postWebViewMessage({ type: 'setCounter', data: { newCounter: this.counter * 10 } });
    });
  }
